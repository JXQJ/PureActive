...
namespace PureActive.Logging.Abstractions.Types
{
    ...
    /// <summary>
    /// Class NullPureLogger.
    /// Implements the <see cref="PureActive.Logging.Abstractions.Types.NullPureLogger" />
    /// Implements the <see cref="PureActive.Logging.Abstractions.Interfaces.IPureLogger{TCategory}" />
    /// </summary>
    /// <typeparam name="TCategory">The type of the t category.</typeparam>
    /// <seealso cref="PureActive.Logging.Abstractions.Types.NullPureLogger" />
    /// <seealso cref="PureActive.Logging.Abstractions.Interfaces.IPureLogger{TCategory}" />
    /// <autogeneratedoc />

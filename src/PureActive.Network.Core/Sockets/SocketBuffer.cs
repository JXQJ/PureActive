...
// ***********************************************************************
// <copyright file="SocketBuffer.cs" company="BushChang Corporation">
...
namespace PureActive.Network.Core.Sockets
{
    ...
    public class SocketBuffer
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">size - Size must be greater then 0 and less then 65536</exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException">buffer - buffer length must be less then or equal to the socket buffer capacity</exception>

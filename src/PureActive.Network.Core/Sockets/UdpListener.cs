...
// ***********************************************************************
// <copyright file="UdpListener.cs" company="BushChang Corporation">
...
namespace PureActive.Network.Core.Sockets
{
    ...
    public class UdpListener : SocketListener
    {
        ...
        /// <exception cref="InvalidOperationException">Udp listener is already active and must be stopped before starting</exception>

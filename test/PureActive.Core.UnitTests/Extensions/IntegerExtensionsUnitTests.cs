...
{
    [Trait("Category", "Unit")]
    public class IntegerExtensionsTests : TestLoggerBase<IntegerExtensionsTests>
    {
        public IntegerExtensionsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {

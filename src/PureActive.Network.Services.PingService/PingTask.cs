...
namespace PureActive.Network.Services.PingService
{
    ...
    public partial class PingService
    {
        ...
        public class PingTaskImpl : IPingTask
        {
            ...
            /// </summary>
            /// <autogeneratedoc />
            public event PingReplyEventHandler OnPingReplyTask;
            ...
            public async Task PingNetworkAsync(IPAddressSubnet ipAddressSubnet, CancellationToken cancellationToken,
                int timeout, PingOptions pingOptions, int pingCallLimit = int.MaxValue, int waitBetweenPings = 0, bool shuffle = true)
            {
                ...
                try
                {
                    foreach (var ipAddress in networkEnumerator.Take(pingCallLimit))
                    {
                        ...
                        OnPingReplyTask?.Invoke(this, pingReplyEventArgs);
                ...
                {
                    _logger.LogDebug(ex, "PingNetworkAsync task cancelled");
                }
            }
            ...
            public Task PingNetworkAsync(IPAddressSubnet ipAddressSubnet, CancellationToken cancellationToken,
                int timeout, int pingCallLimit, int waitBetweenPings, bool shuffle)
            {
                return PingNetworkAsync(ipAddressSubnet, cancellationToken, timeout, _pingOptions, pingCallLimit, waitBetweenPings, shuffle);
            }
        }
    }
}
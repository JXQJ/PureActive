...
namespace PureActive.Network.Services.PingService
{
    ...
    public partial class PingService : BackgroundServiceInternal<PingService>, IPingService
    {
        ...
        /// <autogeneratedoc />
        public PingService(ICommonServices commonServices, INetworkingService networkingService, IApplicationLifetime applicationLifetime = null) :
            base(commonServices, applicationLifetime, ServiceHost.PingService)
        {
            ...
            _networkingService = networkingService ?? throw new ArgumentNullException(nameof(networkingService));
        ...
        {
            var iPAddressSubnet = _networkingService.GetDefaultGatewayAddressSubnet();

...
{
    [Trait("Category", "Unit")]
    public class GuidExtensionsTests : TestLoggerBase<GuidExtensionsTests>
    {
        public GuidExtensionsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {

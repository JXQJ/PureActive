...
{
    [Trait("Category", "Unit")]
    public class IPAddressExtensionsTests : TestLoggerBase<IPAddressExtensionsTests>
    {
        public IPAddressExtensionsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {

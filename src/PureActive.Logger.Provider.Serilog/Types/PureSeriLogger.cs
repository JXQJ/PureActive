...
namespace PureActive.Logger.Provider.Serilog.Types
{
    ...
    /// <summary>
    /// Class PureSeriLogger.
    /// Implements the <see cref="PureActive.Logger.Provider.Serilog.Types.PureSeriLogger" />
    /// Implements the <see cref="PureActive.Logging.Abstractions.Interfaces.IPureLogger{T}" />
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <seealso cref="PureActive.Logger.Provider.Serilog.Types.PureSeriLogger" />
    /// <seealso cref="PureActive.Logging.Abstractions.Interfaces.IPureLogger{T}" />
    /// <autogeneratedoc />

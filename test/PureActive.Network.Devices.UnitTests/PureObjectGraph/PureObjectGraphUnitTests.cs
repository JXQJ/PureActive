...
{
    [Trait("Category", "Unit")]
    public class PureObjectGraphTests : TestLoggerBase<PureObjectGraphTests>
    {
        public PureObjectGraphTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {

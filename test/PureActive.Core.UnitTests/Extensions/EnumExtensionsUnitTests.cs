...
{
    [Trait("Category", "Unit")]
    public class EnumExtensionsTests : TestLoggerBase<EnumExtensionsTests>
    {
        public EnumExtensionsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {

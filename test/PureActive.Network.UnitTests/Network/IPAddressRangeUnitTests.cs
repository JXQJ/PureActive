...
{
    [Trait("Category", "Unit")]
    public class IPAddressRangeTests : TestLoggerBase<IPAddressRangeTests>
    {
        public IPAddressRangeTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
